if select(3, UnitClass("player")) == 6 then
    ...
    function KeyToggles()
        ...
        -- AoE Button
            if AoEModesLoaded ~= "DK Rotation Modes" then
                CustomAoEModes = {
                    ...
                    [4] = { mode = "Off", value = 4 , overlay = "DPS Rotation Disabled", tip = "Disable DPS Rotation", highlight = 0}
                };
                AoEModes = CustomAoEModes
                CreateButton("AoE",1,0)
                AoEModesLoaded = "DK Rotation Modes";
            end

        -- Cooldowns Button
            if CooldownsModesLoaded ~= "DK Cooldown Modes" then
                ...
                CooldownsModesLoaded = "DK Cooldown Modes";
            end

        -- Defensive Button
            if DefensiveModesLoaded ~= "DK Defensive Modes" then
                ...
                DefensiveModesLoaded = "DK Defensive Modes";
            end

        -- Interrupts Button
            if InterruptsModesLoaded ~= "DK Interrupt Modes" then
                ...
                InterruptsModesLoaded = "DK Interrupt Modes";
            end
        -- Cleave Button
            if CleaveModesLoaded ~= "DK Cleave Modes" then
                CustomCleaveModes = {
                ...
                CleaveModesLoaded = "DK Cleave Modes";
            end
