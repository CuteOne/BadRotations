...
--------------
        ...
        local power, powmax, powgen, powerDeficit           = br.player.power.amount.holyPower, br.player.power.holyPower.max, br.player.power.regen, br.player.power.holyPower.deficit
