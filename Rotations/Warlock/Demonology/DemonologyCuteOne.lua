    ...
    --------------------------
        ...
        ---------------------------
            ...
            -- Doom
                        ...
                        for i = 1, #enemies.yards40 do
                            ...
                            if UnitIsUnit(thisUnit,"target") or hasThreat(thisUnit) or isDummy(thisUnit) then
                                if not talent.handOfDoom and ttd(thisUnit) > doom.duration and (not doom or doom.remain < doom.duration * 0.3) and br.timer:useTimer("delayDoom", gcd) then
            ...
            -- Shadowflame
                        ...
                        if charges.shadowflame == 2 --[[and br.timer:useTimer("travelTime", travelTime)]] then 
                            if cast.shadowflame() then return end
                        end
            -- Thal'kiel's Consumption
