...
----------------
    ...
    --------------
            ...
            atonementCount = 0
            for i=1, #br.friend do
                local atonementRemain = getBuffRemain(br.friend[i].unit,spell.spec.buffs.atonement,"player") or 0 -- 194384
...
--------------------
            ...
            function actionList_SingleTarget()
                ...
                if isChecked("Plea") then
                    for i = 1, #br.friend do                           
                        if br.friend[i].hp <= getValue("Plea") and getBuffRemain(br.friend[i].unit, spell.spec.buffs.atonement, "player") < 1 and lastSpell ~= spell.plea and atonementCount < 6 then
