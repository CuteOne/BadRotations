...
--------------------
    ...
    --Mind Bender
        ...
        if isChecked("Shadowfiend / Mindbender") and talent.mindbender and charges.chadowWordDeath.count() == 0 then
...
-- Action List - VoidForm
    ...
    -- Void Torrent
        ...
        if isChecked("Void Torrent") and artifact.voidTorrent.enabled() and useCDs()
