...
--------------------
                ...
                function actionList_Single()
					...
					if (not talent.lethalShots or buff.lethalShots.exists()) and trait.focusedFire.active() or trait.inTheRhytm.rank() > 1 then
            ...
            function actionList_Cooldowns()
                if useCDs() then
                 ...
                 charges.aimedShot.frac() < 1 and charges.aimedShot.recharge() < gcdMax then
