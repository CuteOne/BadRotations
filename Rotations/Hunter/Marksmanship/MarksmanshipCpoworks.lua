...
----------------
    ...
    --------------
            ...
            local power, powerMax, powerRegen, powerDeficit     = br.player.power, br.player.powerMax, br.player.powerRegen, br.player.powerDeficit
    ...
    tinsert(cMarksmanship.rotations, {
        name = rotationName,
