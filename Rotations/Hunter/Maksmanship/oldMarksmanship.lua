if select(3, UnitClass("player")) == 3 then
  ...
  function MarkHunter()
    ...
    if UnitAffectingCombat("player") == true and UnitExists("target") == true and UnitIsVisible("target") == true
      ...
      --Cooldowns--------------------------------------------------------------------------------------------------
      -- Rapid Fire
      if br.data["Cooldowns"] == 3 or (isChecked("Rapid Fire") and br.data["Cooldowns"] == 2) then
      ...
      if (br.data['Cooldowns'] == 2 and isChecked("Potions") == true) or br.data['Cooldowns'] == 3 then
      ...
      -- actions+=/rapid_fire
      if (br.data['Cooldowns'] == 2 and isChecked("Rapid Fire") == true) or br.data['Cooldowns'] == 3 then
      ...
      if (br.data['Cooldowns'] == 2 and isChecked("Stampede") == true) or br.data['Cooldowns'] == 3 then
      ...
      if getHP("target") > 80 or UnitBuffID("player",3045) ~= nil then
        ...
        if isKnown(117050) and getSpellCD(117050) == 0 then
          if br.data['AoE'] == 2 or (br.data['AoE'] == 3 and myEnemies > 2) then
        ...
        if isKnown(109259) then
          if br.data['AoE'] == 2 or (br.data['AoE'] == 3 and myEnemies > 1) and power_shot_regen < focus_defecit then
      ...
      if (isKnown(82939) and isChecked("Explosive Trap") and getSpellCD(82939) == 0) and UnitBuffID("player",77769) ~= nil then
        if br.data['AoE'] == 2 or (br.data['AoE'] == 3 and myEnemies > 1) and getGround("target") == true and isMoving("target") ~= true then
      ...
      if isKnown(2643) and getSpellCD(2643) == 0 then
        if br.data['AoE'] == 2 or (br.data['AoE'] == 3 and myEnemies >= 5) then
