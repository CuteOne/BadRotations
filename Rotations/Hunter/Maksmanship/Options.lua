if select(3, UnitClass("player")) == 3 then
    ...
    -- Config Panel
    function MarkConfig()
        bb.ui.window.profile = bb.ui:createProfileWindow("Marksmanship")
        local section
        ...
        -- Rapid Fire
        bb.ui:createCheckbox(section, "Rapid Fire","Check if you want to use Rapid Fire automatically")
        ...
        -- Disengage
        bb.ui:createSpinner(section, "Disengage", 20, 0, 100  , 5, "|cffFFDD11Auto use |cffFFFFFFDisengage |cffFFDD11at set range")
        bb.ui:checkSectionState(section)
        ...
        -- Kill Shot
        bb.ui:createCheckbox(section,"Stop for Kill Shot","Check if you want to stop casting to use Kill Shot");
