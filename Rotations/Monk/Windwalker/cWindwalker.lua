...
function cWindwalker:new()
    ...
    --------------
        ...
        function self.getCastable()
            ...
            self.cast.debug.flyingSerpentKick       = self.cast.flyingSerpentKick("player",true)            
            self.cast.debug.flyingSerpentKickEnd    = self.cast.flyingSerpentKickEnd("player",true)            
