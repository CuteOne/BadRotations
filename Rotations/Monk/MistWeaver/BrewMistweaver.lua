...
local text = {
    ...
    selfDefense      = {
        ...
        healingElixirOrDiffuseMagicOrDampenHarm = colors.red ..
        "5P | " .. colors.purple .. "Healing Elixir / Diffuse Magic / Dampen Harm",
...
local text2 = {
    ...
    selfDefense2      = {
        ...
        healingElixirOrDiffuseMagicOrDampenHarm2 = colors.red ..
        "20P | " .. colors.purple .. "Healing Elixir / Diffuse Magic / Dampen Harm",
...
local function createToggles()
    ...
    local CooldownModes = {
        [1] = { mode = "Auto", value = 1, overlay = "Cooldowns Automated", tip = "Automatic Cooldowns - Boss Detection.", highlight = 1, icon = br.player.spells.lifeCocoon },
        [2] = { mode = "On", value = 1, overlay = "Cooldowns Enabled", tip = "Cooldowns used regardless of target.", highlight = 1, icon = br.player.spells.lifeCocoon },
        [3] = { mode = "Off", value = 3, overlay = "Cooldowns Disabled", tip = "No Cooldowns will be used.", highlight = 0, icon = br.player.spells.lifeCocoon }
    }
    br.ui:createToggle(CooldownModes, "Cooldown", 2, 0)
    local ThunderFocusTeaModes = {
        [1] = { mode = "Auto", value = 1, overlay = "Thunder Focus Tea Mode Auto", tip = "Thunder Focus Tea Mode Auto", highlight = 1, icon = br.player.spells.thunderFocusTea },
        [2] = { mode = "EM", value = 2, overlay = "Thunder Focus Tea Mode - Enveloping Mist", tip = "Thunder Focus Tea Mode - Enveloping Mist", highlight = 1, icon = br.player.spells.envelopingMist },
        [3] = { mode = "VVF", value = 3, overlay = "Thunder Focus Tea Mode - Vivify", tip = "Thunder Focus Tea Mode - Vivify", highlight = 1, icon = br.player.spells.vivify },
        [4] = { mode = "RM", value = 4, overlay = "Thunder Focus Tea Mode - Renewing Mist", tip = "Thunder Focus Tea Mode - Renewing Mist", highlight = 1, icon = br.player.spells.renewingMist },
        [5] = { mode = "RSK", value = 5, overlay = "Thunder Focus Tea Mode - Rising Sun Kick", tip = "Thunder Focus Tea Mode - Rising Sun Kick", highlight = 1, icon = br.player.spells.risingSunKick }
    }
    br.ui:createToggle(ThunderFocusTeaModes, "ThunderFocusTea", 3, 0)
    local DPSModes = {
        [1] = { mode = "Auto", value = 1, overlay = "Automatic Rotation", tip = "Swaps between Single and Multiple based on number of targets in range.", highlight = 1, icon = br.player.spells.tigerPalm },
        [2] = { mode = "Mult", value = 2, overlay = "Multiple Target Rotation", tip = "Multiple target rotation used.", highlight = 1, icon = br.player.spells.spinningCraneKick },
        [3] = { mode = "Sing", value = 3, overlay = "Single Target Rotation", tip = "Single target rotation used.", highlight = 1, icon = br.player.spells.tigerPalm },
        [4] = { mode = "Off", value = 4, overlay = "DPS Rotation Disabled", tip = "Disable DPS Rotation", highlight = 0, icon = br.player.spells.vivify }
    }
    br.ui:createToggle(DPSModes, "DPS", 4, 0)
    local InterruptModes = {
        [1] = { mode = "On", value = 1, overlay = "Interrupts Enabled", tip = "Includes Basic Interrupts.", highlight = 1, icon = br.player.spells.paralysis },
        [2] = { mode = "Off", value = 2, overlay = "Interrupts Disabled", tip = "No Interrupts will be used.", highlight = 0, icon = br.player.spells.paralysis }
    }
    br.ui:createToggle(InterruptModes, "Interrupt", 5, 0)
    local DetoxModes = {
        [1] = { mode = "On", value = 1, overlay = "Detox Enabled", tip = "Detox Enabled", highlight = 1, icon = br.player.spells.detox },
        [2] = { mode = "Off", value = 2, overlay = "Detox Disabled", tip = "Detox Disabled", highlight = 0, icon = br.player.spells.detox }
    }
    br.ui:createToggle(DetoxModes, "Detox", 6, 0)
    local RollModes = {
        [1] = { mode = "On", value = 1, overlay = "Auto Roll Enabed", tip = "Auto Roll enabled", highlight = 1, icon = br.player.spells.roll },
        [2] = { mode = "Off", value = 2, overlay = "Auto Roll Disabled", tip = "Auto Roll Disabled", highlight = 0, icon = br.player.spells.roll },
    }
...
local function createOptions()
    ...
    local function dungeonsettings()
        ...
        br.ui:createSpinner(section, text.heal.lifeCocoon, 30, 1, 100, 5, "Enable auto usage of this spell",
            "Health of unit to cast spell")
        br.ui:createDropdownWithout(section, text.heal.lifeCocoonMode,
            { colors.blue .. "Any", colors.green .. "Tank", colors.red .. "Tank/Healer" }, 2,
            "Use ability only on selected type " .. colors.green .. "(default: Tank)")
        ...
        br.ui:createSpinner(section, text.heal.thunderFocusTea.envelopingMist, 50, 1, 100, 1,
            "Enable auto usage of this spell", "Health of unit to cast spell")
        br.ui:createDoubleSpinner(section, text.heal.thunderFocusTea.vivify,
            ...
            { number = 70, min = 1, max = 100, step = 5, tooltip = "Health of friends to cast spell" }, false)
        br.ui:createSpinner(section, text.heal.thunderFocusTea.renewingMist, 90, 1, 100, 1,
            "Enable auto usage of this spell", "Health of unit to cast spell")
        ...
        br.ui:createSpinner(section, text.heal.soothingMist.soothingMist, 85, 1, 100, 1,
            "Enable auto usage of this spell", "Health of unit to cast spell")
        br.ui:createSpinner(section, text.heal.soothingMist.envelopingMist, 80, 1, 100, 1,
            "Enable auto usage of this spell", "Health of unit to cast spell")
        br.ui:createSpinner(section, text.heal.soothingMist.vivify, 75, 1, 100, 1, "Enable auto usage of this spell",
            "Health of unit to cast spell")
        br.ui:createDoubleSpinner(section, text.heal.soothingMist.vivifyAoE,
            ...
            { number = 70, min = 1, max = 100, step = 5, tooltip = "Health of friends to cast spell" }, false)
        br.ui:createSpinner(section, text.heal.soothingMist.expelHarm, 75, 1, 100, 1, "Enable auto usage of this spell",
            "Health of unit to cast spell")
        br.ui:createText(section, "5P | Other - Options")

        br.ui:createDoubleSpinner(section, text.heal.sheilunsGift,
            { number = 2, min = 1, max = 10, step = 1, tooltip =
            "Enable casting sheilun's gift when [x] number of mists exist" },
            { number = 85, min = 1, max = 100, step = 5, tooltip = "Health of friend to cast spell" }, false)

        br.ui:createSpinner(section, text.heal.renewingMist, 100, 1, 100, 1, "Enable auto usage of this spell",
            "Health of unit to cast spell")
        br.ui:createSpinner(section, text.heal.vivify, 80, 1, 100, 1, "Enable auto usage of this spell",
            "Health of unit to cast spell")
        br.ui:createSpinner(section, text.heal.envelopingMist, 70, 1, 100, 1, "Enable auto usage of this spell",
            "Health of unit to cast spell")
        ...
        br.ui:createSpinner(section, text.heal.zenPulse, 90, 1, 100, 1, "Enable auto usage of this spell",
            "Health of unit to cast spell")
        br.ui:checkSectionState(section)
        ...
        br.ui:createCheckbox(section, text.utility.manaTeaWithYulon,
            "Enable auto usage of this spell when Yulon is activated")
        br.ui:createDropdown(section, text.utility.summonJadeSerpentStatue, { "Around Tank", "Around Player" }, 2,
            "Enable usage of this spell around option", "Select")
        ...
        br.ui:createSpinner(section, text.selfDefense.healingElixirOrDiffuseMagicOrDampenHarm, 65, 1, 100, 05,
            "Enable auto usage of this spell", "Health of player to cast spell")
        br.ui:createSpinner(section, text.selfDefense.fortifyingBrew, 65, 1, 100, 05, "Enable auto usage of this spell",
            "Health of player to cast spell")
        ...
        br.ui:createSpinner(section, text.selfDefense.expelHarm, 40, 0, 100, 05, "Enable auto usage of this spell",
            "Health Percent to Cast At")
        br.ui:checkSectionState(section)

        section = br.ui:createSection(br.ui.window.profile, text.damage.options)
        br.ui:createSpinnerWithout(section, text.damage.dpsThreshold, 85, 1, 100, 5,
            "Lowest friend HP has to be higher then")
        br.ui:createSpinnerWithout(section, text.damage.chiJiDpsThreshold, 60, 1, 100, 5,
            "Lowest friend HP has to be higher then")

        br.ui:createCheckbox(section, text.damage.cracklingJadeLightning, "Enable auto usage of this spell")
        br.ui:createDropdown(section, text.damage.touchOfDeath,
            { colors.blue .. "Always", colors.green .. "Bosses", colors.red .. "Never" }, 2,
            "Enable auto usage of this spell.", "Select")
        br.ui:checkSectionState(section)
    end
    local function raidsettings()
        ...
        br.ui:createSpinner(section, text2.heal2.lifeCocoon2, 30, 1, 100, 5, "Enable auto usage of this spell",
            "Health of unit to cast spell")
        br.ui:createDropdownWithout(section, text2.heal2.lifeCocoonMode2,
            { colors.blue .. "Any", colors.green .. "Tank", colors.red .. "Tank/Healer" }, 2,
            "Use ability only on selected type " .. colors.green .. "(default: Tank)")
        ...
        br.ui:createSpinner(section, text2.heal2.thunderFocusTea2.envelopingMist2, 50, 1, 100, 1,
            "Enable auto usage of this spell", "Health of unit to cast spell")
        br.ui:createDoubleSpinner(section, text2.heal2.thunderFocusTea2.vivify2,
            { number = 80, min = 1, max = 100, step = 1, tooltip = "Mana of player to cast spell" },
            { number = 70, min = 1, max = 100, step = 5, tooltip = "Health of friends to cast spell" }, false)
        br.ui:createSpinner(section, text2.heal2.thunderFocusTea2.renewingMist2, 90, 1, 100, 1,
            "Enable auto usage of this spell", "Health of unit to cast spell")
        ...
        br.ui:createSpinner(section, text2.heal2.soothingMist2.soothingMist2, 85, 1, 100, 1,
            "Enable auto usage of this spell", "Health of unit to cast spell")
        br.ui:createSpinner(section, text2.heal2.soothingMist2.envelopingMist2, 80, 1, 100, 1,
            "Enable auto usage of this spell", "Health of unit to cast spell")
        br.ui:createSpinner(section, text2.heal2.soothingMist2.vivify2, 75, 1, 100, 1, "Enable auto usage of this spell",
            "Health of unit to cast spell")
        br.ui:createDoubleSpinner(section, text2.heal2.soothingMist2.vivifyAoE2,
            ...
            { number = 70, min = 1, max = 100, step = 5, tooltip = "Health of friends to cast spell" }, false)
        br.ui:createSpinner(section, text2.heal2.soothingMist2.expelHarm2, 75, 1, 100, 1,
            "Enable auto usage of this spell", "Health of unit to cast spell")
        ...
        br.ui:createSpinner(section, text2.heal2.renewingMist2, 94, 1, 100, 1, "Enable auto usage of this spell",
            "Health of unit to cast spell")
        br.ui:createSpinner(section, text2.heal2.vivify2, 80, 1, 100, 1, "Enable auto usage of this spell",
            "Health of unit to cast spell")
        br.ui:createSpinner(section, text2.heal2.envelopingMist2, 70, 1, 100, 1, "Enable auto usage of this spell",
            "Health of unit to cast spell")
        ...
        br.ui:createDoubleSpinner(section, text2.heal2.faelineStomp2,
            { number = 2, min = 1, max = 40, step = 1, tooltip = "Amount of friends under health to cast spell" },
            { number = 95, min = 1, max = 100, step = 5, tooltip = "Health of friends to cast spell" }, false)
        br.ui:createSpinner(section, text2.heal2.zenPulse2, 90, 1, 100, 1, "Enable auto usage of this spell",
            "Health of unit to cast spell")
        br.ui:checkSectionState(section)
        ...
        br.ui:createCheckbox(section, text2.utility2.manaTeaWithYulon2,
            "Enable auto usage of this spell when Yulon is activated")
        br.ui:createDropdown(section, text2.utility2.summonJadeSerpentStatue2, { "Around Tank", "Around Player" }, 2,
            "Enable usage of this spell around option", "Select")
        ...
        br.ui:createSpinner(section, text2.selfDefense2.healingElixirOrDiffuseMagicOrDampenHarm2, 65, 1, 100, 05,
            "Enable auto usage of this spell", "Health of player to cast spell")
        br.ui:createSpinner(section, text2.selfDefense2.fortifyingBrew2, 65, 1, 100, 05,
            "Enable auto usage of this spell", "Health of player to cast spell")
        br.ui:createDoubleSpinner(section, text2.selfDefense2.legSweep2,
            { number = 2, min = 1, max = 40, step = 1, tooltip = "Number of Units in 5 Yards to Cast At" },
            { number = 70, min = 1, max = 100, step = 5, tooltip = "or Health Percent to Cast At" }, false)
        br.ui:createSpinner(section, text2.selfDefense2.expelHarm2, 40, 0, 100, 05, "Enable auto usage of this spell",
            "Health Percent to Cast At")
        br.ui:checkSectionState(section)

        section = br.ui:createSection(br.ui.window.profile, text2.damage2.options2)
        br.ui:createSpinnerWithout(section, text2.damage2.dpsThreshold2, 85, 1, 100, 5,
            "Lowest friend HP has to be higher then")
        br.ui:createSpinnerWithout(section, text2.damage2.chiJiDpsThreshold2, 60, 1, 100, 5,
            "Lowest friend HP has to be higher then")

        br.ui:createCheckbox(section, text2.damage2.cracklingJadeLightning2, "Enable auto usage of this spell")
        br.ui:createDropdown(section, text2.damage2.touchOfDeath2,
            { colors.blue .. "Always", colors.green .. "Bosses", colors.red .. "Never" }, 2,
            "Enable auto usage of this spell.", "Select")
        br.ui:checkSectionState(section)
    end
...
local buildSingleActionMessage = function(thisFriend, spellName)
    return "[SUCCESS]: " ..
    spellName .. colors.white .. " [" .. thisFriend.name .. "][" .. formatHPColor(getRealHP(thisFriend.unit)) .. "] "
end
                    ...
                    if friends.lowest.role == "TANK" or (lifeCocoonMode == 3 and friends.lowest.role == "HEALER") or lifeCocoonMode == 1 then
                        if friends.lowest.hp <= ui.value(text.heal.lifeCocoon) and cast.able.lifeCocoon(friends.lowest.unit) then
                            if cast.lifeCocoon(friends.lowest.unit) then
                                ui.debug(buildSingleActionMessage(friends.lowest, text.heal.lifeCocoon))
                                return true
                            end
                        end
                    end
            ...
            if br.player.ui.mode.content == 1 then
                if ui.checked(text.heal.revival) and cd.revival.ready() then
                    if friends.lowAllies.revival >= ui.value(text.heal.revival .. "1") then
                        if cast.revival(player.unit) then
                            ui.debug(buildAOEActionMessage(friends.lowAllies.revival, text.heal.revival))
                            return true
                        end
                    end
                end
            elseif br.player.ui.mode.content == 2 then
                if ui.checked(text2.heal2.revival2) and cd.revival.ready() then
                    if friends.lowAllies.revival >= ui.value(text2.heal2.revival2 .. "1") then
                        if cast.revival(player.unit) then
                            ui.debug(buildAOEActionMessage(friends.lowAllies.revival, text2.heal2.revival2))
                            return true
                        end
                    end
                end
                ...
                if ui.checked(text.heal.invokeYulonTheJadeSerpent) and cd.invokeYulonTheJadeSerpent.ready() then
                    if not talent.invokeChiJiTheRedCrane and friends.lowAllies.invokeYulonTheJadeSerpent >= ui.value(text.heal.invokeYulonTheJadeSerpent .. "1") then
                        if cast.invokeYulonTheJadeSerpent() then
                            ui.debug(buildAOEActionMessage(friends.lowAllies.invokeYulonTheJadeSerpent,
                                text.heal.invokeYulonTheJadeSerpent))
                            return true
                        end
                    end
                end
            ...
            if br.player.ui.mode.content == 1 then
                if ui.checked(text.heal.invokeChiJiTheRedCrane) and cd.invokeChiJiTheRedCrane.ready() then
                    if talent.invokeChiJiTheRedCrane and
                        ...
                        if cast.invokeChiJiTheRedCrane(player.unit) then
                            ui.debug(buildAOEActionMessage(friends.lowAllies.invokeChiJiTheRedCrane,
                                text.heal.invokeChiJiTheRedCrane))
                            return true
                        end
                    end
                end
            elseif br.player.ui.mode.content == 2 then
                if ui.checked(text2.heal2.invokeChiJiTheRedCrane2) and cd.invokeChiJiTheRedCrane.ready() then
                    if talent.invokeChiJiTheRedCrane and
                        ...
                        cast.able.invokeChiJiTheRedCrane(player.unit) then
                        if cast.invokeChiJiTheRedCrane(player.unit) then
                            ui.debug(buildAOEActionMessage(friends.lowAllies.invokeChiJiTheRedCrane2,
                                text2.heal2.invokeChiJiTheRedCrane2))
                            return true
                        end
                    end
                end
                    ...
                    if renewingMistUnit ~= nil then
                        if cast.able.renewingMist(renewingMistUnit.unit) then
                            if cast.renewingMist(renewingMistUnit.unit) then
                                ui.debug(buildSingleActionMessage(renewingMistUnit, text.heal.renewingMist))
                                return true
                            end
                        end
                    end
            ...
            elseif br.player.ui.mode.content == 2 then
                ...
                if ui.checked(text2.heal2.renewingMist2) and charges.renewingMist.exists() and cd.renewingMist.ready() then
                    ...
                    if renewingMistUnit ~= nil and cast.able.renewingMist(renewingMistUnit.unit) then
                        if cast.renewingMist(renewingMistUnit.unit) then
                            ui.debug(buildSingleActionMessage(renewingMistUnit, text2.heal2.renewingMist2))
                            return false
                        end
                    end
                end
                    ...
                    if ui.mode.thunderFocusTea == 1 or ui.mode.thunderFocusTea == 2 and not player.isMoving then -- EM
                        ...
                        if ui.checked(text.heal.thunderFocusTea.envelopingMist) and friends.lowest.hp <= ui.value(text.heal.thunderFocusTea.envelopingMist) and cd.envelopingMist.ready() then
                            if cast.thunderFocusTea(player.unit) and cast.envelopingMist(friends.lowest.unit) then
                                ...
                                ui.debug("[TFT FAIL]: " .. text.heal.thunderFocusTea.envelopingMist)
                                return false
                            end
                        end
                    end
                        ...
                        if ui.checked(text.heal.thunderFocusTea.vivify) and friends.lowest.hp <= ui.value(text.heal.thunderFocusTea.vivify .. "2") and cd.vivify.ready() then
                            if player.mana <= ui.value(text.heal.thunderFocusTea.vivify .. "1") then
                                if cast.thunderFocusTea(player.unit) and cast.vivify(friends.lowest.unit) then
                                    ...
                                    ui.debug("[TFT FAIL]: " .. text.heal.thunderFocusTea.vivify)
                                    return false
                                end
                            end
                        end
                    ...
                    if ui.mode.thunderFocusTea == 1 or ui.mode.thunderFocusTea == 4 then -- RM
                        ...
                        if ui.checked(text.heal.thunderFocusTea.renewingMist) and friends.lowest.hp <= ui.value(text.heal.thunderFocusTea.renewingMist) and not buff.renewingMist.exists(friends.lowest.unit) and charges.renewingMist.exists() and cd.renewingMist.ready() then
                            if cast.thunderFocusTea(player.unit) and cast.renewingMist(friends.lowest.unit) then
                                ...
                                ui.debug("[TFT FAIL]: " .. text.heal.thunderFocusTea.renewingMist)
                                return false
                            end
                        end
                    end
                    if ui.mode.thunderFocusTea == 1 or ui.mode.thunderFocusTea == 5 then -- RSK
                        ...
                        if ui.checked(text.heal.thunderFocusTea.risingSunKick) and cd.risingSunKick.ready() and dynamic.range5 ~= nil and br._G.ObjectIsFacing(player.unit, dynamic.range5) then
                            if cast.thunderFocusTea(player.unit) and cast.risingSunKick(friends.lowest.unit) then
                                ...
                                ui.debug("[TFT FAIL]: " .. text.heal.thunderFocusTea.risingSunKick)
                                return false
                            end
                        end
                    end
                    ...
                    if ui.mode.thunderFocusTea == 1 or ui.mode.thunderFocusTea == 2 and not player.isMoving then -- EM
                        ...
                        if ui.checked(text2.heal2.thunderFocusTea2.envelopingMist2) and friends.lowest.hp <= ui.value(text2.heal2.thunderFocusTea2.envelopingMist2) and cd.envelopingMist.ready() then
                            if cast.thunderFocusTea(player.unit) and cast.envelopingMist(friends.lowest.unit) then
                                ...
                                ui.debug("[TFT FAIL]: " .. text2.heal2.thunderFocusTea2.envelopingMist2)
                                return false
                            end
                        end
                    end
                        ...
                        if ui.checked(text2.heal2.thunderFocusTea2.vivify2) and friends.lowest.hp <= ui.value(text2.heal2.thunderFocusTea2.vivify2 .. "2") and cd.vivify.ready() then
                            if player.mana <= ui.value(text2.heal2.thunderFocusTea2.vivify2 .. "1") then
                                if cast.thunderFocusTea(player.unit) and cast.vivify(friends.lowest.unit) then
                                    ...
                                    ui.debug("[TFT FAIL]: " .. text2.heal2.thunderFocusTea2.vivify2)
                                    return false
                                end
                            end
                        end
                    ...
                    if ui.mode.thunderFocusTea == 1 or ui.mode.thunderFocusTea == 4 then -- RM
                        ...
                        if ui.checked(text2.heal2.thunderFocusTea2.renewingMist2) and friends.lowest.hp <= ui.value(text2.heal2.thunderFocusTea2.renewingMist2) and not buff.renewingMist.exists(friends.lowest.unit) and charges.renewingMist.exists() and cd.renewingMist.ready() then
                            if cast.thunderFocusTea(player.unit) and cast.renewingMist(friends.lowest.unit) then
                                ...
                                ui.debug("[TFT FAIL]: " .. text2.heal2.thunderFocusTea2.renewingMist2)
                                return false
                            end
                        end
                    end
                    if ui.mode.thunderFocusTea == 1 or ui.mode.thunderFocusTea == 5 then -- RSK
                        ...
                        if ui.checked(text2.heal2.thunderFocusTea2.risingSunKick2) and cd.risingSunKick.ready() and dynamic.range5 ~= nil and br._G.ObjectIsFacing(player.unit, dynamic.range5) then
                            if cast.thunderFocusTea(player.unit) and cast.risingSunKick(friends.lowest.unit) then
                                ...
                                ui.debug("[TFT FAIL]: " .. text2.heal2.thunderFocusTea2.risingSunKick2)
                                return false
                            end
                        end
                    end
                    ...
                    if ui.checked(text.heal.soothingMist.vivifyAoE) and cd.vivify.ready() then
                        ...
                        if countUnitsWithRenewingMistUnderHealth >= ui.value(text.heal.soothingMist.vivifyAoE .. "1") and
                            ...
                            if cast.vivify(friends.lowest.unit) then
                                ui.debug(buildSingleActionMessage(friends.lowest, text.heal.soothingMist.vivifyAoE))
                                return true
                            end
                        end
                    end
                ...
                if cast.active.soothingMist() and friends.lowest.unit == lastSoothingMist.unit then
                    ...
                    if ui.checked(text2.heal2.soothingMist2.vivifyAoE2) and cd.vivify.ready() then
                        ...
                        if countUnitsWithRenewingMistUnderHealth >= ui.value(text2.heal2.soothingMist2.vivifyAoE2 .. "1") and
                            cast.able.vivify(friends.lowest.unit) then
                            if cast.vivify(friends.lowest.unit) then
                                ui.debug(buildSingleActionMessage(friends.lowest, text2.heal2.soothingMist2.vivifyAoE2))
                                return true
                            end
                        end
                    end
                ...
                if ui.checked(text.heal.essenceFont) and cd.essenceFont.ready() then
                    if friends.lowAllies.essenceFont >= ui.value(text.heal.essenceFont .. "1") and cast.able.essenceFont() then
                        if cast.essenceFont() then
                            ui.debug("[SUCCESS]: " .. text.heal.essenceFont)
                            return true
                        end
                    end
                end
                    ...
                    if totemInfo.yulonDuration > cast.time.envelopingMist() + br.getLatency() or totemInfo.chiJiDuration > cast.time.envelopingMist() + br.getLatency() then
                        ...
                        if #lowHealthAroundUnit >= ui.value(text.heal.envelopingBreath .. "1") and cast.able.envelopingMist(friends.lowest.unit) then
                            if cast.envelopingMist(friends.lowest.unit) then
                                ui.debug(buildSingleActionMessage(friends.lowest, text.heal.envelopingBreath))
                                return true
                            end
                        end
                    end
                ...
                if ui.checked(text.heal.refreshingJadeWind) and cd.refreshingJadeWind.ready() and talent.refreshingJadeWind then
                    if friends.lowAllies.refreshingJadeWind >= ui.value(text.heal.refreshingJadeWind .. "1") and cast.able.refreshingJadeWind() then
                        if cast.refreshingJadeWind() then
                            ui.debug("[SUCCESS]: " .. text.heal.refreshingJadeWind)
                            return true
                        end
                    end
                end
            elseif br.player.ui.mode.content == 2 then
                ...
                if ui.checked(text2.heal2.chiBurst2) and cd.chiBurst.ready() and talent.chiBurst and not player.isMoving then
                    ...
                    if lowAlliesTargetsChiBurst >= ui.value(text2.heal2.chiBurst2 .. "1") and cast.able.chiBurst() then
                        if cast.chiBurst() then
                            ui.debug("[SUCCESS]: " .. text2.heal2.chiBurst2)
                            return true
                        end
                    end
                end
                ...
                if ui.checked(text2.heal2.essenceFont2) and cd.essenceFont.ready() then
                    if friends.lowAllies.essenceFont >= ui.value(text2.heal2.essenceFont2 .. "1") and cast.able.essenceFont() then
                        if cast.essenceFont() then
                            ui.debug("[SUCCESS]: " .. text2.heal2.essenceFont2)
                            return true
                        end
                    end
                end
                ...
                if ui.checked(text2.heal2.envelopingBreath2) and cd.envelopingMist.ready() and not player.isMoving then
                    if totemInfo.yulonDuration > cast.time.envelopingMist() + br.getLatency() or totemInfo.chiJiDuration > cast.time.envelopingMist() + br.getLatency() then
                        ...
                        if #lowHealthAroundUnit >= ui.value(text2.heal2.envelopingBreath2 .. "1") and cast.able.envelopingMist(friends.lowest.unit) and
                            ...
                            if cast.envelopingMist(friends.lowest.unit) then
                                ui.debug(buildSingleActionMessage(friends.lowest, text2.heal2.envelopingBreath2))
                                return true
                            end
                        end
                    end
                ...
                if ui.checked(text2.heal2.refreshingJadeWind2) and cd.refreshingJadeWind.ready() and talent.refreshingJadeWind then
                    if friends.lowAllies.refreshingJadeWind >= ui.value(text2.heal2.refreshingJadeWind2 .. "1") and cast.able.refreshingJadeWind() then
                        if cast.refreshingJadeWind(player.unit) then
                            ui.debug("[SUCCESS]: " .. text2.heal2.refreshingJadeWind2)
                            return true
                        else end
                    end
                end
                ...
                if ui.checked(text.heal.faelineStomp) and cd.faelineStomp.ready() and talent.faelineStomp then
                    ...
                    if lowAlliesTargetsfaelineStomp >= ui.value(text.heal.faelineStomp .. "1") and cast.able.faelineStomp() then
                        if cast.faelineStomp() then
                            ui.debug("[SUCCESS]: " .. text.heal.faelineStomp)
                            return true
                        end
                    end
                end
                ...
                if ui.checked(text2.heal2.faelineStomp2) and cd.faelineStomp.ready() and talent.faelineStomp then
                    ...
                    if lowAlliesTargetsfaelineStomp2 >= ui.value(text2.heal2.faelineStomp2 .. "1") and cast.able.faelineStomp() then
                        if cast.faelineStomp(player.unit) then
                            ui.debug("[SUCCESS]: " .. text2.heal2.faelineStomp2)
                            return true
                        end
                    end
                end
            ...
            elseif br.player.ui.mode.content == 2 then
                if ui.checked(text.heal.zenPulse2) and cd.zenPulse.ready() and talent.zenPulse then
                    ...
                    if lowAlliesTargetszenPulse2 >= ui.value(text2.heal2.zenPulse2 .. "1") and cast.able.zenPulse(friends.lowest.unit) then
                        if cast.zenPulse(friends.lowest.unit) then
                            ui.debug(buildSingleActionMessage(friends.lowest, text2.heal2.zenPulse2))
                            return true
                        end
                    end
                end
                ...
                if cast.active.soothingMist() then
                    if (getRealHP(lastSoothingMist.unit) - friends.lowest.hp >= 20 or getRealHP(lastSoothingMist.unit) >= ui.value(text.heal.soothingMist.soothingMist) + 5) then
                        if cast.cancel.soothingMist() then
                            ui.debug("[SUCCESS]: Cancel - " .. text.heal.soothingMist.soothingMist)
                            return true
                        end
                    end
                end
                ...
                if ui.checked(text.heal.soothingMist.soothingMist) and cd.soothingMist.ready() and not cast.active.soothingMist() and not player.isMoving then
                    if friends.lowest.hp <= ui.value(text.heal.soothingMist.soothingMist) and cast.able.soothingMist(friends.lowest.unit) then
                        if cast.soothingMist(friends.lowest.unit) then
                            ...
                            ui.debug(buildSingleActionMessage(friends.lowest, text.heal.soothingMist.soothingMist))
                            return true
                        end
                    end
                end
                ...
                if cast.active.soothingMist() and friends.lowest.unit == lastSoothingMist.unit then
                    ...
                    if ui.checked(text.heal.soothingMist.envelopingMist) and cd.envelopingMist.ready() then
                        if friends.lowest.hp <= ui.value(text.heal.soothingMist.envelopingMist) and
                            ...
                            cast.able.envelopingMist(friends.lowest.unit) then
                            if cast.envelopingMist(friends.lowest.unit) then
                                ui.debug(buildSingleActionMessage(friends.lowest, text.heal.soothingMist.envelopingMist))
                                return true
                            end
                        end
                    end
                    ...
                    if ui.checked(text.heal.soothingMist.expelHarm) and cd.expelHarm.ready() then
                        if friends.lowest.hp <= ui.value(text.heal.soothingMist.expelHarm) and cast.able.expelHarm(friends.lowest.unit) then
                            if cast.expelHarm(friends.lowest.unit) then
                                ui.debug(buildSingleActionMessage(friends.lowest, text.heal.soothingMist.expelHarm))
                                return true
                            end
                        end
                    end
                    ...
                    if ui.checked(text.heal.soothingMist.vivify) and cd.vivify.ready() then
                        if friends.lowest.hp <= ui.value(text.heal.soothingMist.vivify) and cast.able.vivify(friends.lowest.unit) then
                            if cast.vivify(friends.lowest.unit) then
                                ui.debug(buildSingleActionMessage(friends.lowest, text.heal.soothingMist.vivify))
                                return true
                            end
                        end
                    end
            ...
            elseif br.player.ui.mode.content == 2 then
                ...
                if cast.active.soothingMist() then --and lastSoothingMist.unit ~= friends.lowest.unit then
                    if getRealHP(lastSoothingMist.unit) - friends.lowest.hp >= 20 or getRealHP(lastSoothingMist.unit) >= ui.value(text2.heal2.soothingMist2.soothingMist2) + 5 then
                        if cast.cancel.soothingMist() then
                            ui.debug("[SUCCESS]: Cancel - " .. text2.heal2.soothingMist2.soothingMist2)
                            return true
                        end
                    end
                end
                ...
                if ui.checked(text2.heal2.soothingMist2.soothingMist2) and cd.soothingMist.ready() and not cast.active.soothingMist() and not player.isMoving then
                    if friends.lowest.hp <= ui.value(text2.heal2.soothingMist2.soothingMist2) and cast.able.soothingMist(friends.lowest.unit) then
                        if cast.soothingMist(friends.lowest.unit) then
                            ...
                            ui.debug(buildSingleActionMessage(friends.lowest, text2.heal2.soothingMist2.soothingMist2))
                            return true
                        end
                    end
                end
                ...
                if cast.active.soothingMist() and friends.lowest.unit == lastSoothingMist.unit then
                    ...
                    if ui.checked(text2.heal2.soothingMist2.envelopingMist2) and cd.envelopingMist.ready() then
                        if friends.lowest.hp <= ui.value(text2.heal2.soothingMist2.envelopingMist2) and
                            ...
                            cast.able.envelopingMist(friends.lowest.unit) then
                            if cast.envelopingMist(friends.lowest.unit) then
                                ui.debug(buildSingleActionMessage(friends.lowest,
                                    text2.heal2.soothingMist2.envelopingMist2))
                                return true
                            end
                        end
                    end
                    ...
                    if ui.checked(text.heal.soothingMist.expelHarm) and cd.expelHarm.ready() then
                        if friends.lowest.hp <= ui.value(text2.heal2.soothingMist2.expelHarm2) and cast.able.expelHarm(friends.lowest.unit) then
                            if cast.expelHarm(friends.lowest.unit) then
                                ui.debug(buildSingleActionMessage(friends.lowest, text2.heal2.soothingMist2.expelHarm2))
                                return true
                            end
                        end
                    end
                    ...
                    if ui.checked(text.heal.soothingMist.vivify) and cd.vivify.ready() then
                        if friends.lowest.hp <= ui.value(text2.heal2.soothingMist2.vivify2) and cast.able.vivify(friends.lowest.unit) then
                            if cast.vivify(friends.lowest.unit) then
                                ui.debug(buildSingleActionMessage(friends.lowest, text2.heal2.soothingMist2.vivify2))
                                return true
                            end
                        end
                    end
        ...
        singleTargetRotation = function()
            if br.player.ui.mode.content == 1 then
                ...
                if ui.checked(text.heal.chiWave) and cd.chiWave.ready() and talent.chiWave and dynamic.range40 ~= nil then
                    if cast.able.chiWave() then
                        if cast.chiWave() then
                            ui.debug(buildAOEActionMessage(dynamic.range40, text.heal.chiWave))
                            return true
                        end
                    end
                end
                ...
                if ui.checked(text.heal.envelopingMist) and cd.envelopingMist.ready() and not player.isMoving then
                    if friends.lowest.hp <= ui.value(text.heal.envelopingMist) and cast.able.envelopingMist(friends.lowest.unit) then
                        if cast.envelopingMist(friends.lowest.unit) then
                            ui.debug(buildSingleActionMessage(friends.lowest, text.heal.envelopingMist))
                            return true
                        end
                    end
                end
                ...
                if ui.checked(text.heal.vivify) and cd.vivify.ready() and buff.vivaciousVivification.exists(player.unit) then
                    if friends.lowest.hp <= ui.value(text.heal.vivify) and cast.able.vivify(friends.lowest.unit) then
                        if cast.vivify(friends.lowest.unit) then
                            ui.debug(buildSingleActionMessage(friends.lowest, text.heal.vivify))
                            return true
                        end
                    end
            ...
            elseif br.player.ui.mode.content == 2 then
                ...
                if ui.checked(text2.heal2.chiWave2) and cd.chiWave.ready() and talent.chiWave and dynamic.range40 ~= nil then
                    if cast.able.chiWave() then
                        if cast.chiWave() then
                            ui.debug(buildAOEActionMessage(dynamic.range40, text2.heal2.chiWave2))
                            return true
                        end
                    end
                end
                ...
                if ui.checked(text2.heal2.envelopingMist2) and cd.envelopingMist.ready() and not player.isMoving then
                    if friends.lowest.hp <= ui.value(text2.heal2.envelopingMist2) and cast.able.envelopingMist(friends.lowest.unit) then
                        if cast.envelopingMist(friends.lowest.unit) then
                            ui.debug(buildSingleActionMessage(friends.lowest, text2.heal2.envelopingMist2))
                            return true
                        end
                    end
                end
                ...
                if ui.checked(text2.heal2.vivify2) and cd.vivify.ready() and buff.vivaciousVivification.exists(player.unit) then
                    if friends.lowest.hp <= ui.value(text2.heal2.vivify2) and cast.able.vivify(friends.lowest.unit) then
                        if cast.vivify(friends.lowest.unit) then
                            ui.debug(buildSingleActionMessage(friends.lowest, text2.heal2.vivify2))
                            return true
                        end
                    end
    ...
    utility = function()
        if br.player.ui.mode.content == 1 then
            ...
            if ui.checked(text.utility.tigersLust) and talent.tigersLust and cd.tigersLust.ready() then
                for i = 1, #friends.range40 do
                    ...
                    if cast.noControl.tigersLust(tempUnit.unit) then
                        if cast.tigersLust(tempUnit.unit) then
                            ui.debug(buildSingleActionMessage(tempUnit, text.utility.tigersLust))
                            return true
                        end
                    end
                end
            ...
            if ui.checked(text.utility.manaTea) and cd.manaTea.ready() then
                if (player.mana <= ui.value(text.utility.manaTea) or (buff.manaTea.count() > 18 and player.mana <= 80)) and cast.able.manaTea() then
                    if cast.manaTea() then
                        ui.debug("[SUCCESS]: " .. text.utility.manaTea)
                        return true
                    end
                end
            end
            ...
            if ui.checked(text.utility.manaTeaWithYulon) and talent.manaTea and cd.manaTea.ready() and totemInfo.yulonDuration >= 5 then
                if cast.manaTea(player.unit) then
                    ui.debug("[SUCCESS]: " .. text.utility.manaTeaWithYulon)
                    return true
                end
            end
        ...
        elseif br.player.ui.mode.content == 2 then
            ...
            if ui.checked(text2.utility2.tigersLust2) and talent.tigersLust and cd.tigersLust.ready() then
                for i = 1, #friends.range40 do
                    ...
                    if cast.noControl.tigersLust(tempUnit.unit) and cast.able.tigersLust(tempUnit.unit) then
                        if cast.tigersLust(tempUnit.unit) then
                            ui.debug("[SUCCESS]: " .. text2.utility2.tigersLust2)
                            return true
                        end
                    end
                end
            ...
            if ui.checked(text2.utility2.manaTea2) and talent.manaTea and cd.manaTea.ready() then
                if player.mana <= ui.value(text2.utility2.manaTea2) then
                    if cast.manaTea(player.unit) then
                        ui.debug("[SUCCESS]: " .. text2.utility2.manaTea2)
                        return true
                    else end
                end
            end
            ...
            if ui.checked(text2.utility2.manaTeaWithYulon2) and talent.manaTea and cd.manaTea.ready() and totemInfo.yulonDuration >= 5 then
                if cast.manaTea(player.unit) then
                    ui.debug("[SUCCESS]: " .. text2.utility2.manaTeaWithYulon2)
                    return true
                else
                    ui.debug("[FAIL]: " .. text2.utility2.manaTeaWithYulon2)
                    return false
                end
            end
            --Summon Jade Serpent Statue
        ...
        if #enemies.range5f >= 1 then
            if cast.able.blackoutKick() then
                if cast.blackoutKick() then
                    ui.debug("[SUCCESS]:5P | Blackout Kick [ANCIENT]")
                    return true
                else end
            end
            if cast.able.risingSunKick() then
                if cast.risingSunKick() then
                    ui.debug("[SUCCESS]:5P | Rising Sun Kick [ANCIENT")
                    return true
                end
            end
            -- Tiger Palm
            if cast.able.tigerPalm() then
                if cast.tigerPalm() then
                    ui.debug("[SUCCESS]:5P | Tiger Palm [ANCIENT")
                    return true
                end
            end
        end
    ...
    selfDefense = function()
        if br.player.ui.mode.content == 1 then
            ...
            if ui.checked(text.selfDefense.healingElixirOrDiffuseMagicOrDampenHarm) and player.hp <= ui.value(text.selfDefense.healingElixirOrDiffuseMagicOrDampenHarm) then
                if talent.healingElixir and charges.healingElixir.exists() then
                    if cast.healingElixir(player.unit) then
                        ui.debug("[SUCCESS]: " .. text.selfDefense.healingElixirOrDiffuseMagicOrDampenHarm)
                        return true
                    else
                        ui.debug("[FAIL]: " .. text.selfDefense.healingElixirOrDiffuseMagicOrDampenHarm)
                        return false
                    end
                elseif talent.diffuseMagic and cd.diffuseMagic.ready() then
                    if cast.diffuseMagic(player.unit) then
                        ui.debug("[SUCCESS]: " .. text.selfDefense.healingElixirOrDiffuseMagicOrDampenHarm)
                        return true
                    else
                        ui.debug("[FAIL]: " .. text.selfDefense.healingElixirOrDiffuseMagicOrDampenHarm)
                ...
                elseif talent.dampenHarm and cd.dampenHarm.ready() then
                    if cast.dampenHarm(player.unit) then
                        ui.debug("[SUCCESS]: " .. text.selfDefense.healingElixirOrDiffuseMagicOrDampenHarm)
                        return true
                    else
                        ui.debug("[FAIL]: " .. text.selfDefense.healingElixirOrDiffuseMagicOrDampenHarm)
            ...
            if talent.fortifyingBrew and ui.checked(text.selfDefense.fortifyingBrew) and player.hp <= ui.value(text.selfDefense.fortifyingBrew) and cd.fortifyingBrew.ready() then
                if cast.fortifyingBrew(player.unit) then
                    ui.debug("[SUCCESS]: " .. text.selfDefense.fortifyingBrew)
                    return true
                else
                    ui.debug("[FAIL]: " .. text.selfDefense.fortifyingBrew)
                    return false
                end
            end
            -- Leg Sweep
            if ui.checked(text.selfDefense.legSweep) and cd.legSweep.ready() then
                ...
                if #enemies.range6 >= ui.value(text.selfDefense.legSweep .. "1") then
                    if cast.legSweep(player.unit) then
                        ui.debug("[SUCCESS]: " .. text.selfDefense.legSweep)
                        return true
                    else
                        ui.debug("[FAIL]: " .. text.selfDefense.legSweep)
                        return false
                    end
                end
                -- Health
                        ...
                        if talent.spearHandStrike then
                            if cd.spearHandStrike.ready() and ui.checked(text.utility.spearHandStrike) then
                                if cast.spearHandStrike(thisUnit) then
                                    ui.debug("[SUCCESS - INTERRUPT]:5P | Spear Hand Strike")
                                    return true
                                else
                                    ui.debug("[FAIL - INTERRUPT]:5P | Spear Hand Strike")
                                    return false
                                end
                            end
                        end
                        ...
                        if cd.legSweep.ready() and ui.checked(text.selfDefense.legSweep) then
                            if cast.able.legSweep(thisUnit) then
                                if cast.legSweep(thisUnit) then
                                    ui.debug("[SUCCESS - INTERRUPT]:5P | Leg Sweep")
                                    return true
                                else
                                    ui.debug("[FAIL - INTERRUPT]:5P | Leg Sweep")
                                    return false
                                end
                            end
                        end
            ...
            if ui.checked(text.selfDefense.expelHarm) and cd.expelHarm.ready() then
                if player.hp <= ui.value(text.selfDefense.expelHarm) then
                    if cast.expelHarm(player.unit) then
                        ui.debug("[SUCCESS]: " .. text.selfDefense.expelHarm)
                        return true
                    else
                        ui.debug("[FAIL]: " .. text.selfDefense.expelHarm)
                        return false
                    end
                end
            end
        elseif br.player.ui.mode.content == 2 then
            ...
            if ui.checked(text2.selfDefense2.healingElixirOrDiffuseMagicOrDampenHarm2) and player.hp <= ui.value(text2.selfDefense2.healingElixirOrDiffuseMagicOrDampenHarm2) then
                if talent.healingElixir and charges.healingElixir.exists() then
                    if cast.healingElixir(player.unit) then
                        ui.debug("[SUCCESS]: " .. text2.selfDefense2.healingElixirOrDiffuseMagicOrDampenHarm2)
                        return true
                    else
                        ui.debug("[FAIL]: " .. text2.selfDefense2.healingElixirOrDiffuseMagicOrDampenHarm2)
                        return false
                    end
                elseif talent.diffuseMagic and cd.diffuseMagic.ready() then
                    if cast.diffuseMagic(player.unit) then
            ...
            if ui.checked(text2.selfDefense2.fortifyingBrew2) and player.hp <= ui.value(text2.selfDefense2.fortifyingBrew2) and cd.fortifyingBrew.ready() then
                if cast.fortifyingBrew(player.unit) then
                    ui.debug("[SUCCESS]: " .. text2.selfDefense2.fortifyingBrew2)
                    return true
                else
                    ui.debug("[FAIL]: " .. text2.selfDefense2.fortifyingBrew2)
                    return false
                end
            end
            -- Leg Sweep
            if ui.checked(text2.selfDefense2.legSweep2) and cd.legSweep.ready() then
                ...
                if #enemies.range6 >= ui.value(text2.selfDefense2.legSweep2 .. "1") then
                    if cast.legSweep(player.unit) then
                        ui.debug("[SUCCESS]: " .. text2.selfDefense2.legSweep2)
                        return true
                    else
                        ui.debug("[FAIL]: " .. text2.selfDefense2.legSweep2)
                        return false
                    end
                end
                -- Health
                ...
                for i = 1, #enemies.range40 do
                    ...
                    if br.player.unit.interruptable(thisUnit) then
                        ...
                        if cd.spearHandStrike.ready() and ui.checked(text2.utility2.spearHandStrike2) then
                            if cast.spearHandStrike(thisUnit) then
                                ui.debug("[SUCCESS - INTERRUPT]:20P | Spear Hand Strike")
                                return true
                            else
                                ui.debug("[FAIL - INTERRUPT]:20P | Spear Hand Strike")
                                return false
                            end
                        end
                        -- Paralysis
                        if cd.paralysis.ready() and distance < 20 and cast.able.paralysis(thisUnit) then
                            if cast.paralysis(thisUnit) then
                                ui.debug("[SUCCESS - INTERRUPT]:20P | Paralysis")
                                return true
                            else
                                ui.debug("[FAIL - INTERRUPT]:20P | Paralysis")
                                return false
                            end
                        end
                        -- Ring of Peace
                        if talent.ringOfPeace and cd.ringOfPeace.ready() and ui.checked(text2.utility2.ringOfPeace2) then
                            if cast.ringOfPeace(thisUnit, "ground") then
                                ui.debug("[SUCCESS - INTERRUPT]:20P | Ring Of Peace")
                                return true
                            else
                                ui.debug("[FAIL - INTERRUPT]:20P | Ring Of Peace")
                                return false
                            end
                        end
                        -- Leg Sweep
                        if cast.able.legSweep() and ui.checked(text2.selfDefense2.legSweep2) then
                            if cast.legSweep() then
                                ui.debug("[SUCCESS - INTERRUPT]:20P | Leg Sweep")
                                return true
                            else
                                ui.debug("[FAIL - INTERRUPT]:20P | Leg Sweep")
                                return false
                            end
                        end
                    end
            ...
            if ui.checked(text2.selfDefense2.expelHarm2) and cd.expelHarm.ready() then
                if player.hp <= ui.value(text.selfDefense.expelHarm) then
                    if cast.expelHarm(player.unit) then
                        ui.debug("[SUCCESS]: " .. text2.selfDefense2.expelHarm2)
                        return true
                    else
                        ui.debug("[FAIL]: " .. text2.selfDefense2.expelHarm2)
                        return false
                    end
                end
            end
                            ...
                            if touchOfDeathMode == 1 or (touchOfDeathMode == 2 and br.isBoss(thisUnit)) then
                                if unit.health(player.unit) > unit.health(thisUnit) or (br.isBoss(thisUnit) and unit.hp(thisUnit) <= 15) and cast.able.touchofDeath(thisUnit) then
                                    if cast.touchOfDeath(thisUnit) then
                                        ...
                                        ui.debug("[FAIL]: " .. text2.damage2.touchOfDeath2)
                                        return false
                                    end
                                end
                            end
                ...
                if #enemies.range8 >= 3 then
                    ...
                    if cast.able.risingSunKick("target") and br._G.ObjectIsFacing(player.unit, dynamic.range5) then
                        if cast.risingSunKick("target") then
                            ui.debug("[SUCCESS]:5P | Rising Sun Kick AoE")
                            return true
                        end
                    end
                    -- Spinning Crane Kick
                    if cast.able.spinningCraneKick() and not cast.active.spinningCraneKick() then
                        if cast.spinningCraneKick() then
                            ui.debug("[SUCCESS]:5P | Spinning Crane Kick AoE")
                            return true
                        end
                    end
                end
            elseif br.player.ui.mode.content == 2 then
                if #enemies.range8 >= 3 then
                    ...
                    if cast.able.risingSunKick() and br._G.ObjectIsFacing(player.unit, dynamic.range5) then
                        if cast.risingSunKick(dynamic.range5) then
                            ui.debug("[SUCCESS]:20P | Rising Sun Kick AoE")
                            return true
                        end
                    end
                    -- Spinning Crane Kick
                    if cast.able.spinningCraneKick() and not cast.active.spinningCraneKick() then
                        if cast.spinningCraneKick(player.unit) then
                            ui.debug("[SUCCESS]:20P | Spinning Crane Kick AoE")
                            return true
                        end
                    end
                end
            ...
            if br.player.ui.mode.content == 1 then
                if dynamic.range5 ~= nil and br._G.ObjectIsFacing(player.unit, dynamic.range5) then
                    ...
                    if cast.able.risingSunKick(dynamic.range5) then
                        if cast.risingSunKick(dynamic.range5) then
                            ui.debug("[SUCCESS]:5P | Rising Sun Kick ST")
                            return true
                        end
                    end
                    -- Tiger Palm
                    if cast.able.tigerPalm(dynamic.range5) then
                        if cast.tigerPalm(dynamic.range5) then
                            ui.debug("[SUCCESS]:5P | Tiger Palm ST")
                            return true
                        end
                    end
                end
            elseif br.player.ui.mode.content == 2 then
                if dynamic.range5 ~= nil and br._G.ObjectIsFacing(player.unit, dynamic.range5) then
                    ...
                    if cd.risingSunKick.ready() then
                        if cast.risingSunKick(dynamic.range5) then
                            ui.debug("[SUCCESS]:20P | Rising Sun Kick ST")
                            return true
                        else
                            ui.debug("[FAIL]:20P | Rising Sun Kick ST")
                            return false
                        end
                    end
                    -- Blackout Kick
                    if cd.blackoutKick.ready() and buff.teachingsOfTheMonastery.stack() == 3 then
                        if cast.blackoutKick(dynamic.range5) then
                            ui.debug("[SUCCESS]:20P | Blackout Kick ST")
                            return true
                        else
                            ui.debug("[FAIL]:20P | Blackout Kick ST")
                            return false
                        end
                    end
                    -- Tiger Palm
                    if cd.tigerPalm.ready() then
                        if cast.tigerPalm(dynamic.range5) then
                            ui.debug("[SUCCESS]:20P | Tiger Palm ST")
                            return true
                        else
                            ui.debug("[FAIL]:20P | Tiger Palm ST")
                            return false
                        end
                    end
                end
        ...
        chiJiRotation = function()
            ...
            if br.player.ui.mode.content == 1 then
                if buff.invokeChiJiTheRedCrane.stack() == 3 or (totemInfo.chiJiDuration == 0 and buff.invokeChiJiTheRedCrane.stack() > 0 and not player.isMoving) then
                    ...
                    if cd.envelopingMist.ready() then
                        ...
                        if cast.envelopingMist(theUnit.unit) then
                            ui.debug("[SUCCESS]: " .. text.heal.envelopingMist)
                            return true
                        else
                            ui.debug("[FAIL]: " .. text.heal.envelopingMist)
                            return false
                        end
                    end
            ...
            elseif br.player.ui.mode.content == 2 then
                if buff.invokeChiJiTheRedCrane.stack() == 3 or (totemInfo.chiJiDuration == 0 and buff.invokeChiJiTheRedCrane.stack() > 0 and not player.isMoving) then
                    ...
                    if cd.envelopingMist.ready() then
                        ...
                        if cast.envelopingMist(theUnit.unit) then
                            ui.debug("[SUCCESS]: " .. text2.heal2.envelopingMist2)
                            return true
                        else
                            ui.debug("[FAIL]: " .. text2.heal2.envelopingMist2)
                            return false
                        end
                    end
                    debugMessage("Enveloping Mist - Chi-Ji End")
            ...
            if br.player.ui.mode.content == 1 then
                if totemInfo.chiJiDuration > 0 and dynamic.range5 ~= nil and friends.lowest.hp >= ui.value(text.damage.chiJiDpsThreshold) then
                    ...
                    if cd.risingSunKick.ready() and br._G.ObjectIsFacing(player.unit, dynamic.range5) then
                        if cast.risingSunKick(dynamic.range5) then
                            ui.debug("[SUCCESS]:5P | Rising Sun Kick Chi-Ji")
                            return true
                        else
                            ui.debug("[FAIL]:5P | Rising Sun Kick Chi-Ji")
                            return false
                        end
                    end
                    ...
                    if cd.blackoutKick.ready() and buff.teachingsOfTheMonastery.stack() == 3 and br._G.ObjectIsFacing(player.unit, dynamic.range5) then
                        if cast.blackoutKick(dynamic.range5) then
                            ui.debug("[SUCCESS]:5P | Blackout Kick Chi-Ji")
                            return true
                        else
                            ui.debug("[FAIL]:5P | Blackout Kick Chi-Ji")
                            return false
                        end
                    end
                    if #enemies.range8 >= 3 then
                        ...
                        if cd.spinningCraneKick.ready() and not cast.active.spinningCraneKick() then
                            if cast.spinningCraneKick(player.unit) then
                                ui.debug("[SUCCESS]:5P | Spinning Crane Kick Chi-Ji")
                                return true
                            else
                                ui.debug("[FAIL]:5P | Spinning Crane Kick Chi-Ji")
                                return false
                            end
                        end
                    else
                        ...
                        if cd.tigerPalm.ready() and br._G.ObjectIsFacing(player.unit, dynamic.range5) then
                            if cast.tigerPalm(dynamic.range5) then
                                ui.debug("[SUCCESS]:5P | Tiger Palm Chi-Ji")
                                return true
                            else
                                ui.debug("[FAIL]:5P | Tiger Palm Chi-Ji")
                                return false
                            end
                        end
                    end
            ...
            elseif br.player.ui.mode.content == 2 then
                if totemInfo.chiJiDuration > 0 and dynamic.range5 ~= nil and friends.lowest.hp >= ui.value(text2.damage2.chiJiDpsThreshold2) then
                    ...
                    if cd.risingSunKick.ready() and br._G.ObjectIsFacing(player.unit, dynamic.range5) then
                        if cast.risingSunKick(dynamic.range5) then
                            ui.debug("[SUCCESS]:20P | Rising Sun Kick Chi-Ji")
                            return true
                        else
                            ui.debug("[FAIL]:20P | Rising Sun Kick Chi-Ji")
                            return false
                        end
                    end
                    -- Blackout Kick on 3 stacks
                    if cd.blackoutKick.ready() and buff.teachingsOfTheMonastery.stack() == 3 and br._G.ObjectIsFacing(player.unit, dynamic.range5) then
                        if cast.blackoutKick(dynamic.range5) then
                            ui.debug("[SUCCESS]:20P | Blackout Kick Chi-Ji")
                            return true
                        else
                            ui.debug("[FAIL]:20P | Blackout Kick Chi-Ji")
                            return false
                        end
                    end
                    if #enemies.range8 >= 3 then
                        ...
                        if cd.spinningCraneKick.ready() and not cast.active.spinningCraneKick() then
                            if cast.spinningCraneKick(player.unit) then
                                ui.debug("[SUCCESS]:20P | Spinning Crane Kick Chi-Ji")
                                return true
                            else
                                ui.debug("[FAIL]:20P | Spinning Crane Kick Chi-Ji")
                                return false
                            end
                        end
                    else
                        ...
                        if cd.tigerPalm.ready() and br._G.ObjectIsFacing(player.unit, dynamic.range5) then
                            if cast.tigerPalm(dynamic.range5) then
                                ui.debug("[SUCCESS]:20P | Tiger Palm Chi-Ji")
                                return true
                            else
                                ui.debug("[FAIL]:20P | Tiger Palm Chi-Ji")
                                return false
                            end
                        end
                    end
            ...
            if br.player.ui.mode.content == 1 then
                ...
                if dynamic.range40 ~= nil and not player.isMoving and not cast.active.cracklingJadeLightning() then
                    if ui.checked(text.damage.cracklingJadeLightning) and cd.cracklingJadeLightning.ready() then
                        if cast.cracklingJadeLightning(dynamic.range40) then
                            ui.debug("[SUCCESS]: " .. text.damage.cracklingJadeLightning)
                            return true
                        else
                            ui.debug("[FAIL]: " .. text.damage.cracklingJadeLightning)
                            return false
                        end
                    end
                end
            elseif br.player.ui.mode.content == 2 then
                if dynamic.range40 ~= nil and not player.isMoving and not cast.active.cracklingJadeLightning() then
                    if ui.checked(text2.damage2.cracklingJadeLightning2) and cd.cracklingJadeLightning.ready() then
                        if cast.cracklingJadeLightning(dynamic.range40) then
                            ui.debug("[SUCCESS]: " .. text2.damage2.cracklingJadeLightning2)
                            return true
                        else
                            ui.debug("[FAIL]: " .. text2.damage2.cracklingJadeLightning2)
                            return false
                        end
                    end
                end
...
local function runRotation()
    ...
    if player.inCombat then
        ...
        if buff.teachingsOfTheMonastery.stack("player") >= 4 then
            if cast.able.blackoutKick() then
                if cast.blackoutKick() then
                    ui.debug("TOM! Casting blackout kick")
                    return true;
                end;
            end
        end
