...
function isDummy(Unit)
	...
	if GetObjectExists(Unit) and UnitGUID(Unit) then
		local dummies = {
			[24792]  = "Advanced Training Dummy",     -- Lvl ?? Boss
			[30527]  = "Training Dummy", 		      -- Lvl ?? Boss
			[92169]  = "Raider's Training Dummy",     -- Tanking
			[113963] = "Raider's Training Dummy", 	  -- Damage
			[96442]  = "Training Dummy", 			  -- Damage
			[79987]  = "Training Dummy", 	          -- Unknown
			[113966] = "Dungeoneer's Training Dummy", -- Lvl 112 - Damage
			[109595] = "Training Dummy",              -- Unknown
			[44703]  = "Training Dummy", 			  -- Lvl 3 (Ammen Vale)
			[111824] = "Training Dummy", 			  -- Lvl 110 (Azsuna)
			...
			[102045] = "Rebellious Wrathguard",       -- Lvl 112 (Dreadscar Rift) - Dungeoneer
			[102052] = "Rebellious Imp", 			  -- Lvl 100 (Dreadscar Rift) - AoE
			[102048] = "Rebellious Felguard",         -- Lvl 100 (Dreadscar Rift)
			...
			[92165]  = "Dungeoneer's Training Dummy", -- Lvl 112 (Eastern Plaguelands) - Damage
			...
			[103404] = "Bulwark Construct",           -- Lvl 112 (Hall of the Guardian) - Dungeoneer
			[93828]  = "Training Dummy",              -- Lvl 102 (Hellfire Citadel)
			[98581]  = "Prepfoot Training Dummy",     -- (Highmountain)
			...
			[113674] = "Imprisoned Centurion",        -- Lvl 102 - 112 (Mardum, the Shattered Abyss) - Dungeoneer
			...
			[108420] = "Training Dummy",              -- Lvl 100 (Stormwind City, Durotar)
			...
			[92168]  = "Dungeoneer's Training Dummy", -- Lvl 112 (The Wandering Isle, Easter Plaguelands)
			[70245]  = "Training Dummy",              -- Lvl ?? (Throne of Thunder)
			[113858] = "Training Dummy",              -- Lvl 110 (Trueshot Lodge) - Damage
			[113862] = "Training Dummy",              -- Lvl 100 - 104 (Trueshot Lodge) - Damage
			[113864] = "Raider's Training Dummy",     -- Lvl ?? (Trueshot Lodge) - Damage
			[113860] = "Raider's Training Dummy",     -- Lvl ?? (Trueshot Lodge) - Damage
			[113863] = "Dungeoneer's Training Dummy", -- Lvl 102 (Trueshot Lodge) - Damage
			[113859] = "Dungeoneer's Training Dummy", -- (Trueshot Lodge) - Damage
			[113871] = "Bombardier's Training Dummy", -- Lvl 102 - 103 (Trueshot Lodge) - Damage
