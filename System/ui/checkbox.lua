...
function createCheckBox(parent,value,x,y,checkState)
	...
	if _G[parent..name.."Check"] == nil then
		if br.data.options[br.selectedSpec] then
			if br.data.options[br.selectedSpec][name.."Check"] == nil then
				if value.base == 1 then
					br.data.options[br.selectedSpec][name.."Check"] = 1
				end
			end
		end
		...
		_G[parent..name.."Check"]:SetAlpha(br.data.BadRotationsUI.alpha)
		...
		if br.data.options[br.selectedSpec] and br.data.options[br.selectedSpec][name.."Check"] == 1 then
		...
		-- varDir = br.data.BadRotationsUI.optionsFrames.options.enemiesEngine
		_G[parent..name.."Check"]:SetScript("OnClick", function()
			if br.data.options[br.selectedSpec][name.."Check"] == 1 then
				br.data.options[br.selectedSpec][name.."Check"] = 0
