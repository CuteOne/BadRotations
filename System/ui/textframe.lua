...
function createTextString(parent,value,x,y,heigth,width)
	...
	_G[parent..value.."TextFrame"]:SetAlpha(bb.data.BadBoyUI.alpha)
...
function createTitleString(parent,value,x,y)
	...
	_G[parent..value.."TitleFrame"]:SetAlpha(bb.data.BadBoyUI.alpha)
	--_G[parent..value.."TextFrame"]:Hide()
	...
	_G[parent..value.."Text"]:SetPoint("TOPLEFT",0,0)
	_G[parent..value.."Text"]:SetAlpha(bb.data.BadBoyUI.alpha)
	_G[parent..value.."Text"]:SetFont(bb.data.BadBoyUI.font,(bb.data.BadBoyUI.fontsize+2)*scale,"THICKOUTLINE")
