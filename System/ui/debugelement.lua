...
function createRow(parent,value,textString)
    ...
    _G[parent..value.."Frame"]:SetHeight(22*scale)
    _G[parent..value.."Frame"]:SetPoint("TOPLEFT",10*scale,-(value*22)*scale)
    ...
    _G[parent..value.."Text"]:SetWidth((BadBoy_data.BadBoyUI[parent.."Frame"].width-25)*scale)
