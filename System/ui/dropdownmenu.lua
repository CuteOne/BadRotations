...
function createDropDownMenu(parent,option,x,y,textString)
	...
	if br.data.options[br.selectedSpec] then
		currentValue = br.data.options[br.selectedSpec][value.."Drop"]
	end
	...
	_G[parent..value.."Drop"]:SetAlpha(br.data.BadRotationsUI.alpha)
	-- texture part
	...
	_G[parent..value.."Drop"].texture:SetTexture((br.data.BadRotationsUI.optionsFrame.color.r + 25)/255,(br.data.BadRotationsUI.optionsFrame.color.g + 25)/255,(br.data.BadRotationsUI.optionsFrame.color.b + 25)/255,br.data.BadRotationsUI.optionsFrame.color.a)
	...
	_G[parent..value.."Drop"]:SetScript("OnEnter", function(self)
		...
		GameTooltip:Show()
		_G[parent..value.."Drop"].texture:SetTexture((br.data.BadRotationsUI.optionsFrame.color.r + 75)/255,(br.data.BadRotationsUI.optionsFrame.color.g + 75)/255,(br.data.BadRotationsUI.optionsFrame.color.b + 75)/255,br.data.BadRotationsUI.optionsFrame.color.a)
	end)
	-- leave event
	...
	_G[parent..value.."DropText"]:SetAlpha(br.data.BadRotationsUI.alpha)
	_G[parent..value.."DropText"]:SetJustifyH("CENTER")
	_G[parent..value.."DropText"]:SetFont(br.data.BadRotationsUI.font,br.data.BadRotationsUI.fontsize*scale,"THICKOUTLINE")
	-- assign the actually selected value to the option
	local textDisplay
	if br.data.options[br.selectedSpec] then
		if dropOptions[br.data.options[br.selectedSpec][value.."Drop"]] ~= nil then
			textDisplay = dropOptions[br.data.options[br.selectedSpec][value.."Drop"]]
		end
	end
...
function createDropDownChild(grandParent,parent,value,x,y,tag,dropOptions,tip)
	...
	_G[parent..value.."DropChild"]:SetAlpha(br.data.BadRotationsUI.alpha)
	-- texture part
	...
	_G[parent..value.."DropChild"].texture:SetTexture((br.data.BadRotationsUI.optionsFrame.color.r - 25)/255,(br.data.BadRotationsUI.optionsFrame.color.g - 25)/255,(br.data.BadRotationsUI.optionsFrame.color.b - 25)/255,br.data.BadRotationsUI.optionsFrame.color.a)
	...
	_G[parent..value.."DropChild"]:SetScript("OnClick", function(self)
		...
		if br.data.options[br.selectedSpec][parent.."Drop"] ~= tag then
			br.data.options[br.selectedSpec][parent.."Drop"] = tag
		end
	...
	_G[parent..value.."DropChild"]:SetScript("OnEnter",function(self)
		-- set button gray
		_G[parent..value.."DropChild"].texture:SetTexture(175/255,175/255,175/255,br.data.BadRotationsUI.optionsFrame.color.a)
		GameTooltip:SetOwner(self,"BOTTOMRIGHT",225,5)
		if tip ~= nil then
			GameTooltip:SetText(tip, nil, nil, nil, nil, true)
		else
	...
	_G[parent..value.."TextChild"]:SetAlpha(br.data.BadRotationsUI.alpha)
	_G[parent..value.."TextChild"]:SetJustifyH("CENTER")
	_G[parent..value.."TextChild"]:SetFont(br.data.BadRotationsUI.font,br.data.BadRotationsUI.fontsize*scale,"THICKOUTLINE")
