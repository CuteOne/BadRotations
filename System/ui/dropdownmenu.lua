...
function createDropDownMenu(parent,option,x,y,textString)
	...
	if bb.data.options[bb.selectedSpec] then
		currentValue = bb.data.options[bb.selectedSpec][value.."Drop"]
	end
	...
	_G[parent..value.."Drop"]:SetAlpha(bb.data.BadBoyUI.alpha)
	-- texture part
	...
	_G[parent..value.."Drop"].texture:SetTexture((bb.data.BadBoyUI.optionsFrame.color.r + 25)/255,(bb.data.BadBoyUI.optionsFrame.color.g + 25)/255,(bb.data.BadBoyUI.optionsFrame.color.b + 25)/255,bb.data.BadBoyUI.optionsFrame.color.a)
	...
	_G[parent..value.."Drop"]:SetScript("OnEnter", function(self)
		...
		GameTooltip:Show()
		_G[parent..value.."Drop"].texture:SetTexture((bb.data.BadBoyUI.optionsFrame.color.r + 75)/255,(bb.data.BadBoyUI.optionsFrame.color.g + 75)/255,(bb.data.BadBoyUI.optionsFrame.color.b + 75)/255,bb.data.BadBoyUI.optionsFrame.color.a)
	end)
	-- leave event
	...
	_G[parent..value.."DropText"]:SetAlpha(bb.data.BadBoyUI.alpha)
	_G[parent..value.."DropText"]:SetJustifyH("CENTER")
	_G[parent..value.."DropText"]:SetFont(bb.data.BadBoyUI.font,bb.data.BadBoyUI.fontsize*scale,"THICKOUTLINE")
	-- assign the actually selected value to the option
	local textDisplay
	if bb.data.options[bb.selectedSpec] then
		if dropOptions[bb.data.options[bb.selectedSpec][value.."Drop"]] ~= nil then
			textDisplay = dropOptions[bb.data.options[bb.selectedSpec][value.."Drop"]]
		end
	end
...
function createDropDownChild(grandParent,parent,value,x,y,tag,dropOptions,tip)
	...
	_G[parent..value.."DropChild"]:SetAlpha(bb.data.BadBoyUI.alpha)
	-- texture part
	...
	_G[parent..value.."DropChild"].texture:SetTexture((bb.data.BadBoyUI.optionsFrame.color.r - 25)/255,(bb.data.BadBoyUI.optionsFrame.color.g - 25)/255,(bb.data.BadBoyUI.optionsFrame.color.b - 25)/255,bb.data.BadBoyUI.optionsFrame.color.a)
	...
	_G[parent..value.."DropChild"]:SetScript("OnClick", function(self)
		...
		if bb.data.options[bb.selectedSpec][parent.."Drop"] ~= tag then
			bb.data.options[bb.selectedSpec][parent.."Drop"] = tag
		end
	...
	_G[parent..value.."DropChild"]:SetScript("OnEnter",function(self)
		-- set button gray
		_G[parent..value.."DropChild"].texture:SetTexture(175/255,175/255,175/255,bb.data.BadBoyUI.optionsFrame.color.a)
		GameTooltip:SetOwner(self,"BOTTOMRIGHT",225,5)
		if tip ~= nil then
			GameTooltip:SetText(tip, nil, nil, nil, nil, true)
		else
	...
	_G[parent..value.."TextChild"]:SetAlpha(bb.data.BadBoyUI.alpha)
	_G[parent..value.."TextChild"]:SetJustifyH("CENTER")
	_G[parent..value.."TextChild"]:SetFont(bb.data.BadBoyUI.font,bb.data.BadBoyUI.fontsize*scale,"THICKOUTLINE")
