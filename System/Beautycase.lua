...
local textureNormal = [[Interface\AddOns\BadRotations\System\media\textureNormal]]
local textureShadow = [[[Interface\AddOns\BadRotations\System\media\textureShadow]]
