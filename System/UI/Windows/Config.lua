...
function br.ui:createConfigWindow()
    ...
    local function callGeneral()
        ...
        br.ui:createSpinner(section, "Notify Not Unlocked", 10, 5, 60, 5,
            "Will alert you at the set interval when Unlocker is not attached.")
        br.ui:createCheckbox(section, "Reset Options",
            "|cffFF0000 WARNING!|cffFFFFFF Checking this will reset setting on reload!")
        br.ui:createCheckbox(section, "Reset Saved Profiles",
    ...
    local function callEnemiesEngine()
        ...
        br.ui:createCheckbox(section, "Tank Aggro = Player Aggro",
        ...
        br.ui:createCheckbox(section, "Attack MC Targets",
            "Check this to allow addon to attack charmed/mind controlled targets.")
        br.ui:createCheckbox(section, "Enhanced Time to Die",
            "A more precise time to die check, but can be ressource heavy.")
        ...
        br.ui:createDropdown(
            section,
            "Wise Target",
            { "Highest %", "Lowest %", "abs Highest", "abs Lowest", "Nearest", "Furthest" },
            1,
            "|cffFFDD11Check if you want to use Wise Targetting, if unchecked there will be no priorisation from hp/range."
        )
        br.ui:createDropdownWithout(section, "Wise Target Frequency", { "Default", "Only on Target Death" }, 1,
        ...
        br.ui:createCheckbox(section, "Boss Detection Only In Instance",
        ...
        br.ui:createCheckbox(section, "Interrupt Only Whitelist",
            "Check to only interrupt casts listed on the whitelist.")
        br.ui:createDropdownWithout(section, "Interrupt Target", { "All", "Target", "Focus", "Marked" }, 1,
    ...
    local function callHealingEngine()
        ...
        br.ui:createCheckbox(section, "HE Active",
            "Uncheck to disable Healing Engine.\nCan improves FPS if you dont rely on Healing Engine.")
        ...
        br.ui:createDropdown(section, "Special Heal", { "Target", "T/M", "T/M/F", "T/F" }, 1,
            "Check this to Heal Special Whitelisted Units.", "Choose who you want to Heal.")
        ...
        br.ui:createCheckbox(section, "Incoming Heals",
            "If checked, it will add incoming health from other healers to hp. Check this if you want to prevent overhealing units.")
        br.ui:createSpinner(section, "Overhealing Cancel", 95, nil, nil, nil,
            "Set Desired Threshold at which you want to prevent your own casts. CURRENTLY NOT IMPLEMENTED!")
        ...
        br.ui:createCheckbox(section, "Healer Line of Sight Indicator",
            "Draws a line to healers. Green In Line of Sight / Red Not In Line of Sight")
        br.ui:checkSectionState(section)
    end
    ...
    local function callOtherFeaturesEngine()
        ...
        br.ui:createSpinner(section, "Profession Helper", 0.5, 0, 1, 0.1, "Check to enable Professions Helper.",
            "Set Desired Recast Delay.")
        br.ui:createDropdown(section, "Prospect Ores", { "SL", "BFA", "Legion", "WoD", "MoP", "Cata", "All" }, 1,
            "Prospect Desired Ores. Profession Helper must be checked.")
        br.ui:createDropdown(section, "Mill Herbs", { "SL", "BFA", "Legion", "WoD", "MoP", "Cata", "All" }, 1,
            "Mill Desired Herbs. Profession Helper must be checked.")
        ...
        br.ui:createCheckbox(section, "Quaking Helper",
            "Auto cancel channeling and block casts during mythic+ affix quaking")
        br.ui:createSpinnerWithout(section, "Catcher/Snatcher Delay", 0.5, 0, 1, 0.1)
        br.ui:createCheckbox(section, "Freehold - Pig Catcher", "Catch pig in Ring of Booty")
        br.ui:createCheckbox(section, "De Other Side - Bomb Snatcher", "Catch bomb in The Manastorms fight")
        br.ui:checkSectionState(section)
    end
    ...
    local function callSettingsEngine()
        ...
        br.ui:createDropdownWithout(section, "Select Settings", profileSettings, 2,
    ...
    local function callQueueEngine()
        ...
        br.ui:createSpinner(section, "Smart Queue", 2, 0.5, 3, 0.1, "Auto cast spells you press (Only EWT support)",
    ...
    local function callHealingOptions()
        ...
        br.ui:createSpinnerWithout(section, "Bwonsamdi's Wrath HP", 30, 1, 100, 5,
            "Set HP to decurse Bwonsamdi's Wrath (Mythic Conclave)")
        br.ui:createSpinnerWithout(section, "Reaping", 20, 1, 100, 5, "Set how many stacks of reaping needed to dispel.")
        br.ui:createSpinnerWithout(section, "Promise of Power", 8, 1, 10, 1,
            "Set how many stacks of promise of power needed to dispel.")
        br.ui:createSpinner(section, "Toxic Brand", 10, 1, 20, 1,
            "Set how many stacks of toxic brand to stop healing party members at.")
        br.ui:createCheckbox(section, "Arcane Burst", "Will dispel Arcane Burst if checked.")
        br.ui:createSpinner(section, "Necrotic Rot", 40, 1, 100, 5,
            "Set how many stacks of necrotic rot to stop healing party members at.")
        br.ui:createSpinnerWithout(section, "Decaying Strike Timer", 5, 1, 20, 1,
            "Set how long to stop healing tank before Decaying Strike is cast.")
        br.ui:checkSectionState(section)
    end
