...
function br.ui:createConfigWindow()
  ...
  --      br.ui:createDropdownWithout(section, "OM Function", {"Old OM","New OM (Beta)"}, 1, "|cffFFDD11Choosing New OM will allow you to test possible FPS improvements")
    ...
    local function callHealingEngine()
        ...
        br.ui:createSpinnerWithout(section, "Reaping", 20, 0, 100, 5, "Set how many stacks of reaping needed to dispel.")
        br.ui:createSpinnerWithout(section, "Promise of Power", 8, 0, 100, 5, "Set how many stacks of promise of power needed to dispel.")
