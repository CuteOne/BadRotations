...
function br.ui:createConfigWindow()
    ...
    local function callGeneral()
        ...
        br.ui:createDropdown(
            section,
            "Addon Debug Messages",
            {"System Only", "Profile Only", "All"},
            3,
    ...
    local function callEnemiesEngine()
        ...
        br.ui:createDropdownWithout(
            section,
            "Wise Target Frequency",
            {"Default", "Only on Target Death"},
            1,
        ...
        br.ui:createCheckbox(
            section,
            "Safe Damage Check",
            "Check to prevent damage to targets you dont want to attack."
        )
        br.ui:createSpinnerWithout(
            section,
        ...
        br.ui:createCheckbox(
            section,
            "Boss Detection Only In Instance",
        ...
        br.ui:createCheckbox(
            section,
            "Only Known Units",
            "Check this to interrupt only on known units using whitelist."
        )
    ...
    local function callHealingEngine()
        ...
        br.ui:createDropdown(
            section,
            "Special Heal",
            {"Target", "T/M", "T/M/F", "T/F"},
            1,
            "Check this to Heal Special Whitelisted Units.",
            "Choose who you want to Heal."
        )
        br.ui:createCheckbox(
            section,
    ...
    local function callOtherFeaturesEngine()
        ...
        br.ui:createSpinner(
            ...
            1,
            0.1,
            "Check to enable Professions Helper.",
            "Set Desired Recast Delay."
        )
        br.ui:createDropdown(
            section,
            "Prospect Ores",
            {"SL", "BFA", "Legion", "WoD", "MoP", "Cata", "All"},
            1,
        ...
        br.ui:createCheckbox(
            section,
            "Fish Oil",
            "Turn Fish into Aromatic Fish Oil. Profession Helper must be checked."
        )
        br.ui:createDropdown(
            section,
            "Bait",
    ...
    local function callSettingsEngine()
        ...
        local saveProfile = function()
            br:saveSettings(
                ...
                br.player.class,
                br.selectedSpec,
                br.selectedProfileName .. "\\" .. profileSettings[br.getValue("Select Settings")]
            )
        end
    ...
    local function callTrackerEngine()
        ...
        br.ui:createScrollingEditBox(
            section,
            "Custom Tracker",
            nil,
            "Type custom search, Can Seperate items by comma",
            300,
            40
        )
        br.ui:checkSectionState(section)
    ...
    local function callQueueEngine()
        ...
        br.ui:createSpinner(
            ...
            3,
            0.1,
            "Auto cast spells you press (Only EWT support)",
    ...
    local function callHealingOptions()
        ...
        br.ui:createSpinnerWithout(
            ...
            100,
            5,
            "Set how many stacks of reaping needed to dispel."
        )
        br.ui:createSpinnerWithout(
            section,
            "Promise of Power",
