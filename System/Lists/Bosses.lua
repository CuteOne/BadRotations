...
--[[
    LibBossIDs-1.0 (trimmed/adapted)
    Source: LibBossIDs-1.0 by Elsia (https://www.wowace.com)
    This file preserves the original section comments and boss name notes.
    The original library exposed `lib.BossIDs = BossIDs`; here we populate
    `br.lists.bossIds` directly to be used by BadRotations.
]]
