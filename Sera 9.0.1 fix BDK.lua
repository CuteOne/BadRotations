local rotationName = "Sera 9.0.1 Simple Fix"
...
local function runRotation()
    ...
    local function damage_List()
        ...
        --marrowrend
        if ((buff.boneShield.remains("player") <= runeTimeTill(5)) or (buff.boneShield.remains("player") <= (gcd + bloodDrinkerCheck * (talent.blooddrinker and 1 or 0) * 2)) or (buff.boneShield.stack() < 3)) and powerDeficit >= 20 then
