local agilityPotion = bb.player.potion.wod.agilityBasic
local intellectPotion = bb.player.potion.wod.intellectBasic
local strengthPotion = bb.player.potion.wod.strengthBasic
local armorPotion = bb.player.potion.wod.armorBasic
local agilityPotionBuff = bb.player.potion.wod.buff.agility
local intellectPotionBuff = bb.player.potion.wod.buff.intellect
local strengthPotionBuff = bb.player.potion.wod.buff.strength
local armorPotionBuff = bb.player.potion.wod.buff.armor

local agilityFlask = bb.player.flask.wod.agilityBig
local intellectFlask = bb.player.flask.wod.intellectBig
local strengthFlask = bb.player.flask.wod.strengthBig
local staminaFlask = bb.player.flask.wod.staminaBig
local agilityFlaskBuff = bb.player.flask.wod.buff.agilityBig
local intellectFlaskBuff = bb.player.flask.wod.buff.intellectBig
local strengthFlaskBuff = bb.player.flask.wod.buff.strengthBig
local staminaFlaskBuff = bb.player.flask.wod.buff.staminaBig

local agilityFood = 
local intellectFood =
local strengthFood =
local staminaFood =
local agilityFoodBuff = 
local intellectFoodBuff =
local strengthFoodBuff =
local staminaFoodBuff =
...
--getClassType # returns class type
function getClassType()
	local classType = nil
	local myClass = getClass()
	local mySpec = GetSpecialization("player")
	--Agility
	if myClass == Hunter 
	or myClass == Rogue
