if select(3, UnitClass("player")) == 1 then
   ...
   function WarriorArmsToggles()
        ...
        if AoEModesLoaded ~= "Arms Warrior AoE Modes" then
            CustomAoEModes = {
			[1] = { mode = "One", value = 1 , overlay = "Single Target Enabled", tip = "", highlight = 0, icon = MortalStrike },
            [2] = { mode = "Two", value = 2 , overlay = "Aoe Enabled", tip = "", highlight = 0, icon = Whirlwind }
            };
		...
		if InterruptsModesLoaded ~= "Arms Interrupt Modes" then
            ...
            InterruptsModesLoaded = "Arms Interrupt Modes";
        end
   ...
   function WarriorProtToggles()
		...
		if AoEModesLoaded ~= "Prot Warrior AoE Modes" then
            CustomAoEModes = {
			[1] = { mode = "One", value = 1 , overlay = "Single Target Enabled", tip = "", highlight = 0, icon = Whirlwind },
            [2] = { mode = "Two", value = 2 , overlay = "Two Target Enabled", tip = "", highlight = 0, icon = Whirlwind },
		...
		if InterruptsModesLoaded ~= "Prot Interrupt Modes" then
            CustomInterruptsModes = {
                [1] = { mode = "On", value = 1 , overlay = "Interrupts Enabled", tip = "", highlight = 1, icon = Pummel },
                [2] = { mode = "Off", value = 2 , overlay = "Interrupts Disabled", tip = "", highlight = 0, icon = Pummel }
            };
			InterruptsModes = CustomInterruptsModes
            CreateButton("Interrupts",2,0)
            InterruptsModesLoaded = "Prot Interrupt Modes";
        end
