if select(3,UnitClass("player")) == 10 then
  ...
  _ChiBurst					=	123986	--Chi Burst
  _ChiExplosion 				=	152174	--Chi Explosion WW
  _ChiExplosionBrM      = 175676 --Chi Explosion BrM
  _ChiWave                    =   115098  --Chi Wave
  _CracklingJadeLightning     =   117952  --Crackling Jade Lightning
  _DampenHarm                 =   122278  --Dampen Harm
  _DiffuseMagic				=	122783	--Diffuse Magic
  _Disable                    =   116095  --Disable
  _Detox                      =   115450  --Detox
  _ElusiveBrew                =   115308 --Elusive Brew
  ...
  _HealingElixirs             = 122280 --Healing Elixirs BrM
  _HurricaneStrike			=	152175	--Hurricane Strike
  ...
  _ComboBreakerChiExplosion	=	159407 --Combo Breaker: Chi Explosion
  ...
  _TigersLust                 =   116841;
  _BlackOxStatue              = 115315;
  _PurifyingBrew              = 119582;
  _StaggerLight = 124275;
