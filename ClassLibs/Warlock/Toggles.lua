...
--[[         ]]     --[[           ]]   --[[]]     --[[]]   --[[           ]]
    ...
    function DemonologyToggles()
        -- Aoe Button
        if  AoEModesLoaded ~= "Demonology Warlock AoE Modes" then 
            AoEModes = { 
            ...
            AoEModesLoaded = "Demonology Warlock AoE Modes";
        end
        -- Interrupts Button
        if  InterruptsModesLoaded ~= "Demonology Warlock Interrupts Modes" then 
            InterruptsModes = { 
            ...
            InterruptsModesLoaded = "Demonology Warlock Interrupts Modes";
        end

        -- Defensive Button
        if  DefensiveModesLoaded ~= "Demonology Warlock Defensive Modes" then 
            DefensiveModes = { 
            ...
            DefensiveModesLoaded = "Demonology Warlock Defensive Modes";
        end
        -- Cooldowns Button
        if  CooldownsModesLoaded ~= "Demonology Warlock Cooldowns Modes" then 
            CooldownsModes = { 
            ...
            CooldownsModesLoaded = "Demonology Warlock Cooldowns Modes";
        end
    end
