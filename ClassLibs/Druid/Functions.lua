...
function feralBuffs()
    ...
    then
        ...
        if isChecked("Mark of the Wild") and not UnitExists("mouseover") then
            for i = 1, #nNova do --members
                if not isBuffed(nNova[i].unit,{115921,20217,1126,90363,159988,160017,160077}) and (#nNova==select(5,GetInstanceInfo()) or select(2,IsInInstance())=="none") then
