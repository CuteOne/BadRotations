...
br.lists.spells.DRUID.Shared = {
            abilities     = {
                ...
                demoralizingRoar        = {99, 1735, 9490, 9747, 9898, 26998}, -- Ranks 1-6
                enrage                  = 5229,
                frenziedRegeneration    = {22842, 22895, 22896, 26999}, -- Ranks 1-4
                growl                   = 6795,
                lacerate                = 33745,
                mangleBear              = {33878, 33986, 33987}, -- Ranks 1-3
                maul                    = {6807, 6808, 6809, 8972, 9745, 9880, 9881, 26996}, -- Ranks 1-8
                swipe                   = {779, 780, 769, 9754, 9908, 26997}, -- Ranks 1-6
                -- Cat Form
                claw                    = {1082, 3029, 5201, 9849, 9850, 27000}, -- Ranks 1-6
                cower                   = {8998, 9000, 9892, 31709, 27004}, -- Ranks 1-5
                ...
                rake                    = {1822, 1823, 1824, 9904, 27003}, -- Ranks 1-5
                ravage                  = {6785, 6787, 9866, 9867, 27005}, -- Ranks 1-5
                rip                     = {1079, 9492, 9493, 9752, 9894, 9896, 27008}, -- Ranks 1-7
                shred                   = {5221, 6800, 8992, 9829, 9830, 27001, 27002}, -- Ranks 1-7
                tigersFury              = {5217, 6793, 9845, 9846}, -- Ranks 1-4
                -- Caster Form
                barkskin                = 22812,
                entanglingRoots         = 339,
                faerieFire              = 770,
            ...
            buffs         = {
                ...
                clearcasting        = 16870,
                enrage              = 5229,
                giftOfTheWild       = {21849, 21850, 26991},
            ...
            debuffs       = {
                ...
                mangleBear          = {33878, 33986, 33987},
                mangleCat           = {33876, 33982, 33983},
